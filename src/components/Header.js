    ...
    return (
      <AppBar
        ...
        <Toolbar className={classes.toolBar}>
          ...
          <Hidden xsDown>
            <div className={classes.searchWrapper}>
              <form className={classes.searchForm}>
                <IconButton
                  aria-label="Who to Warm Call"
                  className={classes.searchIcon}
                >
                  <SearchIcon />
                </IconButton>
                <input className={classes.searchInput} type="text" placeholder="Who to Warm Call" autoFocus="true" />
              </form>
            </div>
          </Hidden>
          ...
          <IconButton color="inherit" onClick={/**Do nothing yet! TODO */ console.log("Dashboard")}>
              <DashboardIcon />
          </IconButton>

          <IconButton color="inherit" onClick={/*Do nothing yet! TODO */ console.log("timeline")}>
              <TimelineIcon />
          </IconButton>

          <IconButton color="inherit" onClick={/*Do nothing yet! TODO */ console.log("code")}>
              <CodeIcon />
          </IconButton>

          <IconButton color="inherit" onClick={/*Do nothing yet! TODO */ console.log("label")}>
              <LabelIcon />
          </IconButton>
